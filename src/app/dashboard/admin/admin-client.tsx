                                ...
                                <tr key={u.id} className="border-b border-border last:border-0">
                                  ...
                                  <td className="px-4 py-2.5 text-right">
                                    <div className="flex items-center justify-end gap-1">
                                      ...
                                      <button onClick={() => handleRemoveUser(u.id)} title="Remove user" className="p-1.5 text-red-400 hover:text-red-500 hover:bg-red-500/10 rounded-lg transition-colors">
